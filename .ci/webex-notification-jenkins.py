...
* _Branch_: {branch}
* _Event_: {event}
* _Test Reports_: [APIC 4.2]({build_url}artifact/apic_4.2_log.html), [APIC 5.2]({build_url}artifact/apic_5.2_log.html), [APIC 6.0]({build_url}artifact/apic_6.0_log.html), [NDO 3.7]({build_url}artifact/ndo_3.7_log.html), [NDO 4.1]({build_url}artifact/ndo_4.1_log.html)
""".format(
