...
{% if apic.fabric_policies.external_connectivity_policy.expected_state.maximum_major_faults is defined %}
    Run Keyword If   ${major}[0] > {{ apic.fabric_policies.external_connectivity_policy.expected_state.maximum_major_faults }}   Run Keyword And Continue On Failure
...
{% if apic.fabric_policies.external_connectivity_policy.expected_state.maximum_minor_faults is defined %}
    Run Keyword If   ${minor}[0] > {{ apic.fabric_policies.external_connectivity_policy.expected_state.maximum_minor_faults }}   Run Keyword And Continue On Failure
