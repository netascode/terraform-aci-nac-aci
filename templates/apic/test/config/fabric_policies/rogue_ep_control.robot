...
Verify Rogue EP Control
    ...
    String   $..epControlP.attributes.adminSt   {{ apic.fabric_policies.rogue_ep_control.admin_state | default(defaults.apic.fabric_policies.rogue_ep_control.admin_state) }}
