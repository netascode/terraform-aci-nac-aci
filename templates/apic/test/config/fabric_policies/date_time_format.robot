...
Verify Date and Time Format
    ...
    String   $..datetimeFormat.attributes.showOffset   {{ apic.fabric_policies.date_time_format.show_offset| default(defaults.apic.fabric_policies.date_time_format.show_offset) | cisco.aac.aac_bool("enabled") }}  