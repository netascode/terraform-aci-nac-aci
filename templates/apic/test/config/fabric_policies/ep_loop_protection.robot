...
Verify EP Loop Protection
    ...
    String   $..epLoopProtectP.attributes.adminSt   {{ apic.fabric_policies.ep_loop_protection.admin_state | default(defaults.apic.fabric_policies.ep_loop_protection.admin_state) | cisco.aac.aac_bool("enabled") }}
