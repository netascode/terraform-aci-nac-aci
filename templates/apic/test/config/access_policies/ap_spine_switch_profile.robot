...
Verify Access Spine Switch Profile {{ spine_switch_profile_name }}
    GET   "/api/mo/uni/infra/spprof-{{ spine_switch_profile_name }}.json?rsp-subtree=full"
    String   $..infraSpineP.attributes.name   {{ spine_switch_profile_name }}
...
Verify Access Spine Switch Profile {{ spine_switch_profile_name }} Policy
    ${selector}=   Set Variable   $..infraSpineP.children[?(@.infraSpineS.attributes.name=='{{ spine_switch_selector_name }}')].infraSpineS
    String   ${selector}..infraRsSpineAccNodePGrp.attributes.tDn   uni/infra/funcprof/spaccnodepgrp-{{ policy_group_name }}
{% endif %}
...
Verify Access Spine Switch Profile {{ spine_switch_profile_name }} Interface Profile
    ...
    String   ${profile}.attributes.tDn   uni/infra/spaccportprof-{{ spine_interface_profile_name }}
