...
Verify Link Level Interface Policy {{ link_level_policy_name }}
    ...
    String   $..fabricHIfPol.attributes.autoNeg   {{ policy.auto | default(defaults.apic.access_policies.interface_policies.link_level_policies.auto) | cisco.aac.aac_bool("on") }}
