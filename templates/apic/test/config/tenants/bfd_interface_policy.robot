...
Verify BFD Interface Policy {{ bfd_name }}
    ...
    String   $..bfdIfPol.attributes.ctrl   {{ 'opt-subif' if bfd.subinterface_optimization | default(defaults.apic.tenants.policies.bfd_interface_policies.subinterface_optimization) == "enabled" else ''}}
    ...
    String   $..bfdIfPol.attributes.echoAdminSt   {{ bfd.echo_admin_state | default(defaults.apic.tenants.policies.bfd_interface_policies.echo_admin_state) }}
