...
{% set ctrl = [] %}
{% if igmp_snoop_pol.fast_leave | default(defaults.apic.tenants.policies.igmp_snooping_policies.fast_leave) == "yes" %}{% set ctrl = ctrl + [("fast-leave")] %}{% endif %}
{% if igmp_snoop_pol.querier | default(defaults.apic.tenants.policies.igmp_snooping_policies.querier) == "yes" %}{% set ctrl = ctrl + [("querier")] %}{% endif %}
...
Verify IGMP Snooping Policy {{ policy_name }}
    ...
    String   $..igmpSnoopPol.attributes.adminSt   {{ igmp_snoop_pol.admin_state | default(defaults.apic.tenants.policies.igmp_snooping_policies.admin_state) }}
