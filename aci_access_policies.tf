...
module "aci_bfd_ipv4_policy" {
  ...
  for_each                  = { for bfd in try(local.access_policies.switch_policies.bfd_policies.bfd_ipv4_policies, []) : bfd.name => bfd if local.modules.aci_bfd_policy && var.manage_access_policies }
  name                      = "${each.value.name}${local.defaults.apic.access_policies.switch_policies.bfd_policies.bfd_ipv4_policies.name_suffix}"
  type                      = "ipv4"
  description               = try(each.value.description, "")
  detection_multiplier      = try(each.value.detection_multiplier, local.defaults.apic.access_policies.switch_policies.bfd_policies.bfd_ipv4_policies.detection_multiplier)
...
module "aci_bfd_ipv6_policy" {
  ...
  for_each                  = { for bfd in try(local.access_policies.switch_policies.bfd_policies.bfd_ipv6_policies, []) : bfd.name => bfd if local.modules.aci_bfd_policy && var.manage_access_policies }
  name                      = "${each.value.name}${local.defaults.apic.access_policies.switch_policies.bfd_policies.bfd_ipv6_policies.name_suffix}"
  type                      = "ipv6"
  description               = try(each.value.description, "")
  detection_multiplier      = try(each.value.detection_multiplier, local.defaults.apic.access_policies.switch_policies.bfd_policies.bfd_ipv6_policies.detection_multiplier)
...
module "aci_access_leaf_switch_policy_group" {
  ...
  bfd_ipv4_policy         = try("${each.value.bfd_ipv4_policy}${local.defaults.apic.access_policies.switch_policies.bfd_policies.bfd_ipv4_policies.name_suffix}", "")
  bfd_ipv6_policy         = try("${each.value.bfd_ipv6_policy}${local.defaults.apic.access_policies.switch_policies.bfd_policies.bfd_ipv6_policies.name_suffix}", "")
