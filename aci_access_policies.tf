...
module "aci_data_plane_policing_policy" {
  ...
  conform_mark_cos     = try(each.value.conform_action == "mark", false) ? try(each.value.conform_mark_cos, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.conform_mark_cos) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.conform_mark_cos
  conform_mark_dscp    = try(each.value.conform_action == "mark", false) ? try(each.value.conform_mark_dscp, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.conform_mark_dscp) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.conform_mark_dscp
  ...
  exceed_mark_cos      = try(each.value.exceed_action == "mark", false) ? try(each.value.exceed_mark_cos, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.exceed_mark_cos) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.exceed_mark_cos
  exceed_mark_dscp     = try(each.value.exceed_action == "mark", false) ? try(each.value.exceed_mark_dscp, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.exceed_mark_dscp) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.exceed_mark_dscp
  ...
  violate_mark_cos     = try(each.value.violate_action == "mark", false) ? try(each.value.violate_mark_cos, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.violate_mark_cos) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.violate_mark_cos
  violate_mark_dscp    = try(each.value.violate_action == "mark", false) ? try(each.value.violate_mark_dscp, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.violate_mark_dscp) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.violate_mark_dscp
  peak_rate            = try(each.value.type == "2R3C", false) ? try(each.value.peak_rate, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.peak_rate) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.peak_rate
  peak_rate_unit       = try(each.value.type == "2R3C", false) ? try(each.value.peak_rate_unit, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.peak_rate_unit) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.peak_rate_unit
  burst_excessive      = try(each.value.type == "2R3C", false) ? try(each.value.burst_excessive, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.burst_excessive) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.burst_excessive
  burst_excessive_unit = try(each.value.type == "2R3C", false) ? try(each.value.burst_excessive_unit, local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.burst_excessive_unit) : local.defaults.apic.access_policies.interface_policies.data_plane_policing_policies.burst_excessive_unit
}
