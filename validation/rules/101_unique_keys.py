class Rule:
    ...
    paths = [
        ...
        "apic.access_policies.switch_policies.bfd_ipv4_policies.name",
        "apic.access_policies.switch_policies.bfd_ipv6_policies.name",
        ...
        "apic.tenants.application_profiles.useg_endpoint_groups.name",
        "apic.tenants.application_profiles.useg_endpoint_groups.physical_domains",
        "apic.tenants.application_profiles.useg_endpoint_groups.vmware_vmm_domains.name",
        "apic.tenants.application_profiles.useg_endpoint_groups.contracts.consumers",
        "apic.tenants.application_profiles.useg_endpoint_groups.contracts.providers",
        "apic.tenants.application_profiles.useg_endpoint_groups.contracts.imported_consumers",
        "apic.tenants.application_profiles.useg_endpoint_groups.useg_attributes.ip_statements.name",
        "apic.tenants.application_profiles.useg_endpoint_groups.useg_attributes.ip_statements.ip",
        "apic.tenants.application_profiles.useg_endpoint_groups.useg_attributes.mac_statements.name",
        "apic.tenants.application_profiles.useg_endpoint_groups.useg_attributes.mac_statements.mac",
        "apic.tenants.application_profiles.useg_endpoint_groups.subnets.ip",
