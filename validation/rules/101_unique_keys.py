class Rule:
    ...
    paths = [
        ...
        "mso.remote_locations.name",
        "mso.tacacs_providers.hostname_ip",
        "mso.login_domains.name",
        "mso.login_domains.providers.host",
        "mso.ca_certificates.name",
        "mso.users.username",
        "mso.users.roles.role",
        "mso.sites.name",
        "mso.sites.apic_urls",
        "mso.sites.ospf_policies.name",
        "mso.sites.pods.id",
        "mso.sites.pods.unicast_tep",
        "mso.sites.pods.spines.id",
        "mso.sites.pods.spines.name",
        "mso.sites.pods.spines.control_plane_tep",
        "mso.tenants.name",
        "mso.tenants.sites",
        "mso.policies.dhcp_relays.name",
        "mso.policies.dhcp_options.name",
        "mso.policies.dhcp_options.options.name",
        "mso.schemas.name",
        "mso.schemas.templates.name",
        "mso.schemas.templates.application_profiles.name",
        "mso.schemas.templates.application_profiles.endpoint_groups.name",
        "mso.schemas.templates.application_profiles.endpoint_groups.subnets.ip",
        "mso.schemas.templates.application_profiles.endpoint_groups.contracts.consumers",
        "mso.schemas.templates.application_profiles.endpoint_groups.contracts.providers",
        "mso.schemas.templates.application_profiles.endpoint_groups.sites.name",
        "mso.schemas.templates.application_profiles.endpoint_groups.sites.physical_domains.name",
        "mso.schemas.templates.application_profiles.endpoint_groups.sites.vmware_vmm_domains.name",
        "mso.schemas.templates.application_profiles.endpoint_groups.sites.static_ports.channel",
        "mso.schemas.templates.application_profiles.endpoint_groups.sites.static_leafs.node",
        "mso.schemas.templates.application_profiles.endpoint_groups.sites.subnets.ip",
        "mso.schemas.templates.vrfs.name",
        "mso.schemas.templates.bridge_domains.name",
        "mso.schemas.templates.bridge_domains.subnets.ip",
        "mso.schemas.templates.bridge_domains.sites.name",
        "mso.schemas.templates.bridge_domains.sites.l3outs",
        "mso.schemas.templates.filters.name",
        "mso.schemas.templates.filters.entries.name",
        "mso.schemas.templates.l3outs.name",
        "mso.schemas.templates.external_endpoint_groups.name",
        "mso.schemas.templates.external_endpoint_groups.subnets.prefix",
        "mso.schemas.templates.external_endpoint_groups.contracts.consumers",
        "mso.schemas.templates.external_endpoint_groups.contracts.providers",
        "mso.schemas.templates.external_endpoint_groups.sites.name",
        "mso.schemas.templates.contracts.name",
        "mso.schemas.templates.contracts.service_graph.nodes.name",
        "mso.schemas.templates.contracts.service_graph.nodes.provider.sites.name",
        "mso.schemas.templates.contracts.service_graph.nodes.consumer.sites.name",
        "mso.schemas.templates.service_graphs.name",
        "mso.schemas.templates.service_graphs.nodes.name",
        "mso.schemas.templates.service_graphs.nodes.sites.name",
        "mso.schemas.templates.sites.name",
    ]
