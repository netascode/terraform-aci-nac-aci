...
| <a name="input_strict_mode"></a> [strict\_mode](#input\_strict\_mode) | MCP strict mode (`mcpMode`). When `true`, emits `mcpMode=on` and strict-mode timers (requires APIC >= 5.2). | `bool` | `false` | no |
...
| <a name="input_strict_init_delay_time"></a> [strict\_init\_delay\_time](#input\_strict\_init\_delay\_time) | MCP strict-mode initial delay in seconds. Minimum value: 0. Maximum value: 1800. | `number` | `0` | no |
| <a name="input_strict_tx_freq"></a> [strict\_tx\_freq](#input\_strict\_tx\_freq) | MCP strict-mode transmit frequency in seconds. Minimum value: 0. Maximum value: 300. | `number` | `0` | no |
| <a name="input_strict_tx_freq_msec"></a> [strict\_tx\_freq\_msec](#input\_strict\_tx\_freq\_msec) | MCP strict-mode transmit frequency in milliseconds. Minimum value: 0. Maximum value: 999. | `number` | `500` | no |
