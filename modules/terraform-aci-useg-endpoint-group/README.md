...
| <a name="input_vmware_vmm_domains"></a> [vmware\_vmm\_domains](#input\_vmware\_vmm\_domains) | List of VMware VMM domains. Default value `netflow`: `false`. Choices `deployment_immediacy`: `immediate`, `lazy`. Default value `deployment_immediacy`: `immediate`. Choices `port_binding`: `dynamic`, `ephemeral`, `static`, `default`. Default value `port_binding`: `default`. | <pre>list(object({<br/>    name                 = string<br/>    deployment_immediacy = optional(string, "immediate")<br/>    port_binding         = optional(string, "default")<br/>    netflow              = optional(bool, false)<br/>    elag                 = optional(string, "")<br/>    active_uplinks_order = optional(string, "")<br/>    standby_uplinks      = optional(string, "")<br/>  }))</pre> | `[]` | no |
