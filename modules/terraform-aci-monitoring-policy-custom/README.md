...
| <a name="input_tacacs_policies"></a> [tacacs\_policies](#input\_tacacs\_policies) | List of TACACS monitoring policies. Default value `audit`: false. | <pre>list(object({<br/>    name              = string<br/>    audit             = optional(bool, null)<br/>    destination_group = optional(string, "")<br/>  }))</pre> | `[]` | no |
