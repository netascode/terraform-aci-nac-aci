...
variable "alias" {
  description = "vxlan Custom QoS Policy alias."
  type        = string
  default     = ""
...
variable "egress_rules" {
  description = "QoS Policy DSCP Dot1p Classifiers. Allowed values `dscp_overlay_target` and `cos_target`: `unspecified` or a number between 0 and 7. Allowed values `dscp_from` and `dscp_to` : `unspecified`, `CS0`, `CS1`, `AF11`, `AF12`, `AF13`, `CS2`, `AF21`, `AF22`, `AF23`, `CS3`, `AF31`, `AF32`, `AF33`, `CS4`, `AF41`, `AF42`, `AF43`, `CS5`, `VA`, `EF`, `CS6`, `CS7` or a number between 0 and 63."
  type = list(object({
    dscp_from  = string
    dscp_to    = string
    dscp_overlay_target = optional(string, "unspecified")
    cos_target = optional(string, "unspecified")
  }))
  default = []
  ...
  validation {
    condition = alltrue([
      for eg in var.egress_rules : try(contains(["unspecified", "CS0", "CS1", "AF11", "AF12", "AF13", "CS2", "AF21", "AF22", "AF23", "CS3", "AF31", "AF32", "AF33", "CS4", "AF41", "AF42", "AF43", "CS5", "VA", "EF", "CS6", "CS7"], eg.dscp_overlay_target), false) || try(tonumber(eg.dscp_overlay_target) >= 0 && tonumber(eg.dscp_overlay_target) <= 63, false)
    ])
    error_message = "`dscp_overlay_target`: Allowed values are `unspecified`, `CS0`, `CS1`, `AF11`, `AF12`, `AF13`, `CS2`, `AF21`, `AF22`, `AF23`, `CS3`, `AF31`, `AF32`, `AF33`, `CS4`, `AF41`, `AF42`, `AF43`, `CS5`, `VA`, `EF`, `CS6`, `CS7` or a number between 0 and 63."
  }
