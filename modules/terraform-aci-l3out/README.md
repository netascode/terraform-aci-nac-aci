...
| <a name="input_import_route_map_names"></a> [import\_route\_map\_names](#input\_import\_route\_map\_names) | List of import route map names. 
<pre>list(object({<br>    name        = string<br>    description = optional(string, "")<br>    type        = string<br>  }))</pre> | `[]` | no |
...
| <a name="input_export_route_map_names"></a> [export\_route\_map\_names](#input\_export\_route\_map\_names) | List of export route map names. 
<pre>list(object({<br>    name        = string<br>    description = optional(string, "")<br>    type        = string<br>  }))</pre> | `[]` | no |
