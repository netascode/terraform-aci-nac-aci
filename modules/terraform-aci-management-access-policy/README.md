...
module "aci_management_access_policy" {
  ...
  https_ssl_cipher_ecdhe_rsa_aes256_sha384 = false
  https_ssl_cipher_ecdhe_rsa_aes128_sha256 = false
...
| <a name="input_https_ssl_cipher_ecdhe_rsa_aes256_sha384"></a> [https\_ssl\_cipher\_ecdhe\_rsa\_aes256\_sha384](#input\_https\_ssl\_cipher\_ecdhe\_rsa\_aes256\_sha384) | ECDHE-RSA-AES256-SHA384 SSL cipher. | `bool` | `true` | no |
| <a name="input_https_ssl_cipher_ecdhe_rsa_aes128_sha256"></a> [https\_ssl\_cipher\_ecdhe\_rsa\_aes128\_sha256](#input\_https\_ssl\_cipher\_ecdhe\_rsa\_aes128\_sha256) | ECDHE-RSA-AES128-SHA256 SSL cipher. | `bool` | `true` | no |
