...
| <a name="input_l1l2_destinations"></a> [l1l2\_destinations](#input\_l1l2\_destinations) | List of L1L2 destinations. | <pre>list(object({<br>    description           = optional(string, "")<br>    name                  = string<br>    mac                   = optional(string)<br>    weight                = optional(number)<br>    pod_id                = optional(number, 1)<br>    redirect_health_group = optional(string, "")<br>    l4l7_device           = string<br>    concrete_device       = string<br>    interface             = string<br>  }))</pre> | `[]` | no |
