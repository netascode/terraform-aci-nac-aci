...
variable "custom_values" {
  ...
  validation {
    condition     = try(var.custom_values.acl_log_rate == "default" || try(tonumber(var.custom_values.acl_log_rate) >= 10 && tonumber(var.custom_values.acl_log_rate) <= 500, false), var.custom_values.acl_log_rate)
    error_message = "Allowed Values: `default` or a number between 10 and 500."
  }

  validation {
    condition     = try(var.custom_values.acl_log_burst == "default" || try(tonumber(var.custom_values.acl_log_burst) >= 10 && tonumber(var.custom_values.acl_log_burst) <= 500, false), var.custom_values.acl_log_burst)
    error_message = "Allowed Values: `default` or a number between 10 and 500."
  }
  ...
  validation {
    condition     = try(var.custom_values.eigrp_rate == "default" || try(tonumber(var.custom_values.eigrp_rate) >= 10 && tonumber(var.custom_values.eigrp_rate) <= 2000, false), var.custom_values.eigrp_rate)
    error_message = "Allowed Values: `default` or a number between 10 and 2000."
  }

  validation {
    condition     = try(var.custom_values.eigrp_burst == "default" || try(tonumber(var.custom_values.eigrp_burst) >= 10 && tonumber(var.custom_values.eigrp_burst) <= 2000, false), var.custom_values.eigrp_burst)
    error_message = "Allowed Values: `default` or a number between 10 and 2000."
  }
  ...
  validation {
    condition     = try(var.custom_values.icmp_rate == "default" || try(tonumber(var.custom_values.icmp_rate) >= 10 && tonumber(var.custom_values.icmp_rate) <= 500, false), var.custom_values.icmp_rate)
    error_message = "Allowed Values: `default` or a number between 10 and 500."
  }

  validation {
    condition     = try(var.custom_values.icmp_burst == "default" || try(tonumber(var.custom_values.icmp_burst) >= 10 && tonumber(var.custom_values.icmp_burst) <= 500, false), var.custom_values.icmp_burst)
    error_message = "Allowed Values: `default` or a number between 10 and 500."
  }

  validation {
    condition     = try(var.custom_values.ifc_rate == "default" || try(tonumber(var.custom_values.ifc_rate) == 10000, false), var.custom_values.ifc_rate)
    error_message = "Allowed Values: `default` or the number 10000."
  }

  validation {
    condition     = try(var.custom_values.ifc_burst == "default" || try(tonumber(var.custom_values.ifc_burst) == 10000, false), var.custom_values.ifc_burst)
    error_message = "Allowed Values: `default` or the number 10000."
  }
  ...
  validation {
    condition     = try(var.custom_values.lacp_rate == "default" || try(tonumber(var.custom_values.lacp_rate) >= 10 && tonumber(var.custom_values.lacp_rate) <= 1000, false), var.custom_values.lacp_rate)
    error_message = "Allowed Values: `default` or a number between 10 and 1000."
  }

  validation {
    condition     = try(var.custom_values.lacp_burst == "default" || try(tonumber(var.custom_values.lacp_burst) >= 10 && tonumber(var.custom_values.lacp_burst) <= 1000, false), var.custom_values.lacp_burst)
    error_message = "Allowed Values: `default` or a number between 10 and 1000."
  }
  ...
  validation {
    condition     = try(var.custom_values.mcp_rate == "default" || try(tonumber(var.custom_values.mcp_rate) >= 10 && tonumber(var.custom_values.mcp_rate) <= 5000, false), var.custom_values.mcp_rate)
    error_message = "Allowed Values: `default` or a number between 10 and 5000."
  }

  validation {
    condition     = try(var.custom_values.mcp_burst == "default" || try(tonumber(var.custom_values.mcp_burst) >= 10 && tonumber(var.custom_values.mcp_burst) <= 5000, false), var.custom_values.mcp_burst)
    error_message = "Allowed Values: `default` or a number between 10 and 5000."
  }

  validation {
    condition     = try(var.custom_values.nd_rate == "default" || try(tonumber(var.custom_values.nd_rate) >= 10 && tonumber(var.custom_values.nd_rate) <= 1000, false), var.custom_values.nd_rate)
    error_message = "Allowed Values: `default` or a number between 10 and 1000."
  }

  validation {
    condition     = try(var.custom_values.nd_burst == "default" || try(tonumber(var.custom_values.nd_burst) >= 10 && tonumber(var.custom_values.nd_burst) <= 1000, false), var.custom_values.nd_burst)
    error_message = "Allowed Values: `default` or a number between 10 and 1000."
  }
  ...
  validation {
    condition     = try(var.custom_values.permit_log_rate == "default" || try(tonumber(var.custom_values.permit_log_rate) >= 10 && tonumber(var.custom_values.permit_log_rate) <= 300, false), var.custom_values.permit_log_rate)
    error_message = "Allowed Values: `default` or a number between 10 and 300."
  }

  validation {
    condition     = try(var.custom_values.permit_log_burst == "default" || try(tonumber(var.custom_values.permit_log_burst) >= 10 && tonumber(var.custom_values.permit_log_burst) <= 300, false), var.custom_values.permit_log_burst)
    error_message = "Allowed Values: `default` or a number between 10 and 300."
  }

  validation {
    condition     = try(var.custom_values.pim_rate == "default" || try(tonumber(var.custom_values.pim_rate) >= 10 && tonumber(var.custom_values.pim_rate) <= 500, false), var.custom_values.pim_rate)
    error_message = "Allowed Values: `default` or a number between 10 and 500."
  }

  validation {
    condition     = try(var.custom_values.pim_burst == "default" || try(tonumber(var.custom_values.pim_burst) >= 10 && tonumber(var.custom_values.pim_burst) <= 500, false), var.custom_values.pim_burst)
    error_message = "Allowed Values: `default` or a number between 10 and 500."
  }

  validation {
    condition     = try(var.custom_values.stp_rate == "default" || try(tonumber(var.custom_values.stp_rate) >= 10 && tonumber(var.custom_values.stp_rate) <= 1000, false), var.custom_values.stp_rate)
    error_message = "Allowed Values: `default` or a number between 10 and 1000."
  }

  validation {
    condition     = try(var.custom_values.stp_burst == "default" || try(tonumber(var.custom_values.stp_burst) >= 10 && tonumber(var.custom_values.stp_burst) <= 1000, false), var.custom_values.stp_burst)
    error_message = "Allowed Values: `default` or a number between 10 and 1000."
  }
