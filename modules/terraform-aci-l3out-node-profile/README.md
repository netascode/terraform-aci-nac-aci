...
| <a name="input_vxlan_enabled"></a> [vxlan\_enabled](#input\_vxlan\_enabled) | VXLAN L3out flag. | `bool` | `false` | no |
...
| <a name="input_vxlan_custom_qos_policy"></a> [vxlan\_custom\_qos\_policy](#input\_vxlan\_custom\_qos\_policy) | VXLAN Customer QoS Policy | `string` | `""` | no |
...
| [aci_rest_managed.l3extRsLNodePVxlanCustQosPol](https://registry.terraform.io/providers/CiscoDevNet/aci/latest/docs/resources/rest_managed) | resource |
