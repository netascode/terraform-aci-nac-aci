...
| <a name="input_static_aaeps"></a> [static\_aaeps](#input\_static\_aaeps) | List of static aaeps. Allowed values | <pre>list(object({<br/>    aaep                 = string<br/>    encap                = optional(number)<br/>    primary_encap        = optional(number)<br/>    deployment_immediacy = optional(string, "lazy")<br/>    mode                 = optional(string, "regular")<br/>  }))</pre> | n/a | yes |
