...
module "aci_fabric_pod_policy_group" {
  ...
  bgp_route_reflector_policy = try(each.value.bgp_route_reflector_policy, local.defaults.apic.fabric_policies.pod_policy_groups.bgp_route_reflector_policy)
...
module "aci_fabric_spine_interface_policy_group" {
  source = "./modules/terraform-aci-fabric-spine-interface-policy-group"

  for_each          = { for pg in try(local.fabric_policies.spine_interface_policy_groups, []) : pg.name => pg if local.modules.aci_fabric_spine_interface_policy_group && var.manage_fabric_policies }
  name              = "${each.value.name}${local.defaults.apic.fabric_policies.spine_interface_policy_groups.name_suffix}"
  description       = try(each.value.description, "")
  link_level_policy = try("${each.value.link_level_policy}${local.defaults.apic.fabric_policies.interface_policies.link_level_policies.name_suffix}", "")
  macsec_policy     = try("${each.value.macsec_policy}${local.defaults.apic.fabric_policies.macsec_interfaces_policies.name_suffix}", "")
...
module "aci_tacacs" {
  ...
  retries             = try(each.value.retries, null)
...
module "aci_management_access_policy" {
  ...
  https_ssl_cipher_ecdhe_ecdsa_aes128_ccm        = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_aes128_ccm, null)
  https_ssl_cipher_ecdhe_ecdsa_aes128_gcm_sha256 = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_aes128_gcm_sha256, null)
  https_ssl_cipher_ecdhe_ecdsa_aes256_ccm        = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_aes256_ccm, null)
  https_ssl_cipher_ecdhe_ecdsa_aes256_gcm_sha384 = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_aes256_gcm_sha384, null)
  https_ssl_cipher_ecdhe_ecdsa_chacha20_poly1305 = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_chacha20_poly1305, null)
  https_ssl_cipher_ecdhe_rsa_aes128_gcm_sha256   = try(each.value.https.ssl_ciphers.ecdhe_rsa_aes128_gcm_sha256, null)
  https_ssl_cipher_ecdhe_rsa_aes256_gcm_sha384   = try(each.value.https.ssl_ciphers.ecdhe_rsa_aes256_gcm_sha384, null)
  https_ssl_cipher_ecdhe_rsa_chacha20_poly1305   = try(each.value.https.ssl_ciphers.ecdhe_rsa_chacha20_poly1305, null)
  https_ssl_cipher_tls_aes_128_gcm_sha256        = try(each.value.https.ssl_ciphers.tls_aes_128_gcm_sha256, null)
  https_ssl_cipher_tls_aes_256_gcm_sha384        = try(each.value.https.ssl_ciphers.tls_aes_256_gcm_sha384, null)
  https_ssl_cipher_tls_chacha20_poly1305_sha256  = try(each.value.https.ssl_ciphers.tls_chacha20_poly1305_sha256, null)
  https_ssl_cipher_chacha20                      = try(each.value.https.ssl_ciphers.chacha20, null)
  https_ssl_cipher_dhe_rsa_aes128_sha            = try(each.value.https.ssl_ciphers.dhe_rsa_aes128_sha, null)
  https_ssl_cipher_dhe_rsa_aes256_sha            = try(each.value.https.ssl_ciphers.dhe_rsa_aes256_sha, null)
  https_ssl_cipher_ecdhe_rsa_aes128_sha          = try(each.value.https.ssl_ciphers.ecdhe_rsa_aes128_sha, null)
  https_ssl_cipher_ecdhe_rsa_aes256_sha          = try(each.value.https.ssl_ciphers.ecdhe_rsa_aes256_sha, null)
  https_ssl_cipher_ecdsa                         = try(each.value.https.ssl_ciphers.ecdsa, null)
  https_ssl_cipher_edh_arsa                      = try(each.value.https.ssl_ciphers.edh_arsa, null)
  https_ssl_cipher_eecdh                         = try(each.value.https.ssl_ciphers.eecdh, null)
  https_ssl_cipher_eecdh_arsa_aesgcm             = try(each.value.https.ssl_ciphers.eecdh_arsa_aesgcm, null)
  https_ssl_cipher_eecdh_arsa_sha256             = try(each.value.https.ssl_ciphers.eecdh_arsa_sha256, null)
  https_ssl_cipher_eecdh_arsa_sha384             = try(each.value.https.ssl_ciphers.eecdh_arsa_sha384, null)
