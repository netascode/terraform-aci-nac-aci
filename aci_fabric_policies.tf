...
module "aci_management_access_policy" {
  ...
  https_ssl_cipher_ecdhe_ecdsa_aes128_ccm        = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_aes128_ccm, local.defaults.apic.fabric_policies.pod_policies.management_access_policies.https.ssl_ciphers.ecdhe_ecdsa_aes128_ccm)
  https_ssl_cipher_ecdhe_ecdsa_aes128_gcm_sha256 = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_aes128_gcm_sha256, local.defaults.apic.fabric_policies.pod_policies.management_access_policies.https.ssl_ciphers.ecdhe_ecdsa_aes128_gcm_sha256)
  https_ssl_cipher_ecdhe_ecdsa_aes256_ccm        = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_aes256_ccm, local.defaults.apic.fabric_policies.pod_policies.management_access_policies.https.ssl_ciphers.ecdhe_ecdsa_aes256_ccm)
  https_ssl_cipher_ecdhe_ecdsa_aes256_gcm_sha384 = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_aes256_gcm_sha384, local.defaults.apic.fabric_policies.pod_policies.management_access_policies.https.ssl_ciphers.ecdhe_ecdsa_aes256_gcm_sha384)
  https_ssl_cipher_ecdhe_ecdsa_chacha20_poly1305 = try(each.value.https.ssl_ciphers.ecdhe_ecdsa_chacha20_poly1305, local.defaults.apic.fabric_policies.pod_policies.management_access_policies.https.ssl_ciphers.ecdhe_ecdsa_chacha20_poly1305)
  ...
  https_ssl_cipher_tls_aes_128_gcm_sha256        = try(each.value.https.ssl_ciphers.tls_aes_128_gcm_sha256, local.defaults.apic.fabric_policies.pod_policies.management_access_policies.https.ssl_ciphers.tls_aes_128_gcm_sha256)
  https_ssl_cipher_tls_aes_256_gcm_sha384        = try(each.value.https.ssl_ciphers.tls_aes_256_gcm_sha384, local.defaults.apic.fabric_policies.pod_policies.management_access_policies.https.ssl_ciphers.tls_aes_256_gcm_sha384)
  https_ssl_cipher_tls_chacha20_poly1305_sha256  = try(each.value.https.ssl_ciphers.tls_chacha20_poly1305_sha256, local.defaults.apic.fabric_policies.pod_policies.management_access_policies.https.ssl_ciphers.tls_chacha20_poly1305_sha256)
